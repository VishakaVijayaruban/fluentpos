// --------------------------------------------------------------------------------------------------
// <copyright file="InventoryDbContextFactory.cs" company="FluentPOS">
...
{
    internal class InventoryDbContextFactory : IDesignTimeDbContextFactory<InventoryDbContext>
    {
        public InventoryDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql(
                connectionString,
                e => e.MigrationsAssembly(typeof(InventoryDbContext).Assembly.FullName));
