// --------------------------------------------------------------------------------------------------
// <copyright file="PurchasingDbContextFactory.cs" company="FluentPOS">
...
{
    internal class PurchasingDbContextFactory : IDesignTimeDbContextFactory<PurchasingDbContext>
    {
        public PurchasingDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql(
                connectionString,
                e => e.MigrationsAssembly(typeof(PurchasingDbContext).Assembly.FullName));
