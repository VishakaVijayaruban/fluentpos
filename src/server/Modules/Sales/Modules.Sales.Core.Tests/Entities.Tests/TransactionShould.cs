...
namespace FluentPOS.Modules.Sales.Core.Tests.Entities.Tests
{
    public class TransactionShould
    {
        ...
        public void Records_payment_details_for_an_order()
        {
            ...
            // Act
            var transaction = Transaction.Record(orderId, PaymentType.Cash, amount: 22m, tenderedAmount: 25m, note: "Paid in cash");
        ...
        {
            // Arrange & Act
            var transaction = Transaction.Record(Guid.NewGuid(), PaymentType.CreditCard, amount: 10m, tenderedAmount: 10m, note: null);
