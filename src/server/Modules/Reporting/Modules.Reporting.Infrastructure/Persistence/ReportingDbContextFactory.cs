// --------------------------------------------------------------------------------------------------
// <copyright file="ReportingDbContextFactory.cs" company="FluentPOS">
...
{
    internal class ReportingDbContextFactory : IDesignTimeDbContextFactory<ReportingDbContext>
    {
        public ReportingDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql(
                connectionString,
                e => e.MigrationsAssembly(typeof(ReportingDbContext).Assembly.FullName));
