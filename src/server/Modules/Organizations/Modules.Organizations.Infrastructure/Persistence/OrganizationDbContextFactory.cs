// --------------------------------------------------------------------------------------------------
// <copyright file="OrganizationDbContextFactory.cs" company="FluentPOS">
...
{
    internal class OrganizationDbContextFactory : IDesignTimeDbContextFactory<OrganizationDbContext>
    {
        public OrganizationDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql(
                connectionString,
                e => e.MigrationsAssembly(typeof(OrganizationDbContext).Assembly.FullName));
